...
export const getMyWeeklyLog = createAction(types.GET_MY_WEEKLY_LOG)
export const createMyWeeklyLog = createAction(types.CREATE_MY_WEEKLY_LOG)
export const updateMyWeeklyLog = createAction(types.UPDATE_MY_WEEKLY_LOG)
